...
function loadMemoryScan()
	...
	dialog.Filter=translate("Alice Engine Scan files").." (*.CS)|*.CS"
...
s.LoadFromFile(getAliceEngineDir()..[[autorun\images\export128x128.png]])
...
local s=createPicture()
s.LoadFromFile(getAliceEngineDir()..[[autorun\images\import128x128.png]])
local ii=MainForm.mfImageList.add(s.Bitmap)
